...
func (x *OSS) Reset() {
	*x = OSS{}
	mi := &file_v1_oss_proto_msgTypes[0]
...
func (*OSS) Descriptor() ([]byte, []int) {
	return file_v1_oss_proto_rawDescGZIP(), []int{0}
}
...
func (x *OSS_MinIO) Reset() {
	*x = OSS_MinIO{}
	mi := &file_v1_oss_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OSS_MinIO) Descriptor() ([]byte, []int) {
	return file_v1_oss_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_v1_oss_proto protoreflect.FileDescriptor

const file_v1_oss_proto_rawDesc = "" +
	"\n" +
	"\fv1/oss.proto\x12\x04conf\x1a\fv1/tls.proto\"\xb1\x02\n" +
	"\x03OSS\x12*\n" +
	...
	"\x06_minioB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"

var (
	file_v1_oss_proto_rawDescOnce sync.Once
	file_v1_oss_proto_rawDescData []byte
)

func file_v1_oss_proto_rawDescGZIP() []byte {
	file_v1_oss_proto_rawDescOnce.Do(func() {
		file_v1_oss_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_oss_proto_rawDesc), len(file_v1_oss_proto_rawDesc)))
	})
	return file_v1_oss_proto_rawDescData
}

var file_v1_oss_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_v1_oss_proto_goTypes = []any{
	(*OSS)(nil),       // 0: conf.OSS
	(*OSS_MinIO)(nil), // 1: conf.OSS.MinIO
	(*TLS)(nil),       // 2: conf.TLS
}
var file_v1_oss_proto_depIdxs = []int32{
...
func init() { file_v1_oss_proto_init() }
func file_v1_oss_proto_init() {
	if File_v1_oss_proto != nil {
		return
	}
	file_v1_tls_proto_init()
	file_v1_oss_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_oss_proto_rawDesc), len(file_v1_oss_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v1_oss_proto_goTypes,
		DependencyIndexes: file_v1_oss_proto_depIdxs,
		MessageInfos:      file_v1_oss_proto_msgTypes,
	}.Build()
	File_v1_oss_proto = out.File
	file_v1_oss_proto_goTypes = nil
	file_v1_oss_proto_depIdxs = nil
}
