...
func (*RemoteConfig_Etcd) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{0, 1}
}
...
func (*RemoteConfig_Consul) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{0, 2}
}
...
func (*RemoteConfig_Apollo) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{0, 3}
}
...
func (*RemoteConfig_Kubernetes) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{0, 4}
}
...
func (*RemoteConfig_Polaris) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{0, 5}
}
...
const file_v1_config_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/config.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\"\xef\f\n" +
	...
	"\v_kubernetesB\n" +
	"\n" +
	"\b_polarisB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"
...
func file_v1_config_proto_init() {
	...
	file_v1_config_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
