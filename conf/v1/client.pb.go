...
func (x *Client_REST) Reset() {
	*x = Client_REST{}
	mi := &file_v1_client_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Client_REST) Descriptor() ([]byte, []int) {
	return file_v1_client_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Client_GRPC) Reset() {
	*x = Client_GRPC{}
	mi := &file_v1_client_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Client_GRPC) Descriptor() ([]byte, []int) {
	return file_v1_client_proto_rawDescGZIP(), []int{0, 1}
}
...
const file_v1_client_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/client.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\x1a\x13v1/middleware.proto\x1a\fv1/tls.proto\"\x8c\x03\n" +
	"\x06Client\x12*\n" +
	...
	"\x05_restB\a\n" +
	"\x05_grpcB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"

var (
	file_v1_client_proto_rawDescOnce sync.Once
	file_v1_client_proto_rawDescData []byte
)

func file_v1_client_proto_rawDescGZIP() []byte {
	file_v1_client_proto_rawDescOnce.Do(func() {
		file_v1_client_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_client_proto_rawDesc), len(file_v1_client_proto_rawDesc)))
	})
	return file_v1_client_proto_rawDescData
}

var file_v1_client_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_v1_client_proto_goTypes = []any{
...
func file_v1_client_proto_init() {
	...
	file_v1_client_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_client_proto_rawDesc), len(file_v1_client_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
