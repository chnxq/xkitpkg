...
func (x *Notification_SMS) Reset() {
	*x = Notification_SMS{}
	mi := &file_v1_notify_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Notification_SMS) Descriptor() ([]byte, []int) {
	return file_v1_notify_proto_rawDescGZIP(), []int{0, 0}
}
...
const file_v1_notify_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/notify.proto\x12\x04conf\"\xd6\x01\n" +
	"\fNotification\x12-\n" +
	...
	"\x04_smsB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"

var (
	file_v1_notify_proto_rawDescOnce sync.Once
	file_v1_notify_proto_rawDescData []byte
)

func file_v1_notify_proto_rawDescGZIP() []byte {
	file_v1_notify_proto_rawDescOnce.Do(func() {
		file_v1_notify_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_notify_proto_rawDesc), len(file_v1_notify_proto_rawDesc)))
	})
	return file_v1_notify_proto_rawDescData
}

var file_v1_notify_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_v1_notify_proto_goTypes = []any{
...
func file_v1_notify_proto_init() {
	...
	file_v1_notify_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_notify_proto_rawDesc), len(file_v1_notify_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
