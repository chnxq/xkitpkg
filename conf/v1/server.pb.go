...
func (*Server_REST) Descriptor() ([]byte, []int) {
	return file_v1_server_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*Server_GRPC) Descriptor() ([]byte, []int) {
	return file_v1_server_proto_rawDescGZIP(), []int{0, 1}
}
...
type Server_SignalR struct {
	...
	StreamBufferCapacity uint32                 `protobuf:"varint,7,opt,name=stream_buffer_capacity,json=streamBufferCapacity,proto3" json:"stream_buffer_capacity,omitempty"` // 流缓冲区容量
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type Server_REST_CORS struct {
	...
	Methods       []string               `protobuf:"bytes,2,rep,name=methods,proto3" json:"methods,omitempty"` // 允许的HTTP方法
...
func (*Server_REST_CORS) Descriptor() ([]byte, []int) {
	return file_v1_server_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
const file_v1_server_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/server.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\x1a\x13v1/middleware.proto\x1a\fv1/tls.proto\"\xb5A\n" +
	"\x06Server\x12*\n" +
	...
	"\x06_asynqB\f\n" +
	"\n" +
	"_machineryB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"

var (
	file_v1_server_proto_rawDescOnce sync.Once
	file_v1_server_proto_rawDescData []byte
)

func file_v1_server_proto_rawDescGZIP() []byte {
	file_v1_server_proto_rawDescOnce.Do(func() {
		file_v1_server_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_server_proto_rawDesc), len(file_v1_server_proto_rawDesc)))
	})
	return file_v1_server_proto_rawDescData
}

var file_v1_server_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
