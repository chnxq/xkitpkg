...
func (x *TLS) Reset() {
	*x = TLS{}
	mi := &file_v1_tls_proto_msgTypes[0]
...
func (*TLS) Descriptor() ([]byte, []int) {
	return file_v1_tls_proto_rawDescGZIP(), []int{0}
}
...
type TLS_File struct {
	...
	KeyPath       *string                `protobuf:"bytes,2,opt,name=key_path,json=keyPath,proto3,oneof" json:"key_path,omitempty"`    // 密钥文件路径
	CaPath        *string                `protobuf:"bytes,3,opt,name=ca_path,json=caPath,proto3,oneof" json:"ca_path,omitempty"`       // CA证书文件路径
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TLS_File) Reset() {
	*x = TLS_File{}
	mi := &file_v1_tls_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TLS_File) Descriptor() ([]byte, []int) {
	return file_v1_tls_proto_rawDescGZIP(), []int{0, 0}
}
...
type TLS_Config struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CertPem       []byte                 `protobuf:"bytes,1,opt,name=cert_pem,json=certPem,proto3,oneof" json:"cert_pem,omitempty"` // PEM格式的证书
	KeyPem        []byte                 `protobuf:"bytes,2,opt,name=key_pem,json=keyPem,proto3,oneof" json:"key_pem,omitempty"`    // PEM格式的密钥
	CaPem         []byte                 `protobuf:"bytes,3,opt,name=ca_pem,json=caPem,proto3,oneof" json:"ca_pem,omitempty"`       // PEM格式的CA证书
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TLS_Config) Reset() {
	*x = TLS_Config{}
	mi := &file_v1_tls_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TLS_Config) Descriptor() ([]byte, []int) {
	return file_v1_tls_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_v1_tls_proto protoreflect.FileDescriptor

const file_v1_tls_proto_rawDesc = "" +
	"\n" +
	"\fv1/tls.proto\x12\x04conf\"\xbc\x03\n" +
	"\x03TLS\x12'\n" +
	...
	"\a_ca_pemB\a\n" +
	"\x05_fileB\t\n" +
	"\a_configB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"

var (
	file_v1_tls_proto_rawDescOnce sync.Once
	file_v1_tls_proto_rawDescData []byte
)

func file_v1_tls_proto_rawDescGZIP() []byte {
	file_v1_tls_proto_rawDescOnce.Do(func() {
		file_v1_tls_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_tls_proto_rawDesc), len(file_v1_tls_proto_rawDesc)))
	})
	return file_v1_tls_proto_rawDescData
}

var file_v1_tls_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_v1_tls_proto_goTypes = []any{
	(*TLS)(nil),        // 0: conf.TLS
	(*TLS_File)(nil),   // 1: conf.TLS.File
	(*TLS_Config)(nil), // 2: conf.TLS.Config
}
var file_v1_tls_proto_depIdxs = []int32{
...
func init() { file_v1_tls_proto_init() }
func file_v1_tls_proto_init() {
	if File_v1_tls_proto != nil {
		return
	}
	file_v1_tls_proto_msgTypes[0].OneofWrappers = []any{}
	file_v1_tls_proto_msgTypes[1].OneofWrappers = []any{}
	file_v1_tls_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_tls_proto_rawDesc), len(file_v1_tls_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v1_tls_proto_goTypes,
		DependencyIndexes: file_v1_tls_proto_depIdxs,
		MessageInfos:      file_v1_tls_proto_msgTypes,
	}.Build()
	File_v1_tls_proto = out.File
	file_v1_tls_proto_goTypes = nil
	file_v1_tls_proto_depIdxs = nil
}
