...
func (Registry_Type) EnumDescriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 0}
}
...
type Registry_Etcd struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NameSpace     string                 `protobuf:"bytes,1,opt,name=name_space,json=nameSpace,proto3" json:"name_space,omitempty"` //ETCD名字空间
	Endpoints     []string               `protobuf:"bytes,2,rep,name=endpoints,proto3" json:"endpoints,omitempty"`                  // 服务端地址
	Timeout       *durationpb.Duration   `protobuf:"bytes,3,opt,name=timeout,proto3" json:"timeout,omitempty"`                      // 超时时间
	MaxRetry      int32                  `protobuf:"varint,4,opt,name=max_retry,json=maxRetry,proto3" json:"max_retry,omitempty"`   //重试次数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*Registry_Etcd) Descriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 1}
}
...
func (*Registry_ZooKeeper) Descriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 2}
}
...
func (*Registry_Nacos) Descriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 3}
}
...
func (*Registry_Kubernetes) Descriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 4}
}
...
func (*Registry_Eureka) Descriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 5}
}
...
func (*Registry_Polaris) Descriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 6}
}
...
func (*Registry_Servicecomb) Descriptor() ([]byte, []int) {
	return file_v1_registry_proto_rawDescGZIP(), []int{0, 7}
}
...
const file_v1_registry_proto_rawDesc = "" +
	"\n" +
	"\x11v1/registry.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\"\xd0\x11\n" +
	"\bRegistry\x12\x12\n" +
	...
	"\fhealth_check\x18\x03 \x01(\bR\vhealthCheck\x1a\x95\x01\n" +
	"\x04Etcd\x12\x1d\n" +
	"\n" +
	"name_space\x18\x01 \x01(\tR\tnameSpace\x12\x1c\n" +
	"\tendpoints\x18\x02 \x03(\tR\tendpoints\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12\x1b\n" +
	"\tmax_retry\x18\x04 \x01(\x05R\bmaxRetry\x1a^\n" +
	"\tZooKeeper\x12\x1c\n" +
	...
	"\n" +
	"\b_polarisB\x0e\n" +
	"\f_servicecombB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"
...
var file_v1_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_v1_registry_proto_depIdxs = []int32{
	...
	10, // 8: conf.Registry.Etcd.timeout:type_name -> google.protobuf.Duration
	10, // 9: conf.Registry.ZooKeeper.timeout:type_name -> google.protobuf.Duration
	10, // 10: conf.Registry.Nacos.timeout:type_name -> google.protobuf.Duration
	10, // 11: conf.Registry.Nacos.beat_interval:type_name -> google.protobuf.Duration
	10, // 12: conf.Registry.Nacos.listen_interval:type_name -> google.protobuf.Duration
	10, // 13: conf.Registry.Eureka.heartbeat_interval:type_name -> google.protobuf.Duration
	10, // 14: conf.Registry.Eureka.refresh_interval:type_name -> google.protobuf.Duration
...
func file_v1_registry_proto_init() {
	...
	file_v1_registry_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
