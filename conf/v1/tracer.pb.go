...
func (x *Tracer) Reset() {
	*x = Tracer{}
	mi := &file_v1_tracer_proto_msgTypes[0]
...
func (*Tracer) Descriptor() ([]byte, []int) {
	return file_v1_tracer_proto_rawDescGZIP(), []int{0}
}
...
type BatcherOptions struct {
	...
	MaxQueueSize        uint32                 `protobuf:"varint,2,opt,name=max_queue_size,json=maxQueueSize,proto3" json:"max_queue_size,omitempty"`                      // 最大队列大小
	MaxExportBatchSize  uint32                 `protobuf:"varint,3,opt,name=max_export_batch_size,json=maxExportBatchSize,proto3" json:"max_export_batch_size,omitempty"`  // 最大导出批次大小
	ScheduleDelayMillis uint32                 `protobuf:"varint,4,opt,name=schedule_delay_millis,json=scheduleDelayMillis,proto3" json:"schedule_delay_millis,omitempty"` // 调度延迟（毫秒）
	ExportTimeoutMillis uint32                 `protobuf:"varint,5,opt,name=export_timeout_millis,json=exportTimeoutMillis,proto3" json:"export_timeout_millis,omitempty"` // 导出超时（毫秒）
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *BatcherOptions) Reset() {
	*x = BatcherOptions{}
	mi := &file_v1_tracer_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatcherOptions) Descriptor() ([]byte, []int) {
	return file_v1_tracer_proto_rawDescGZIP(), []int{1}
}
...
var File_v1_tracer_proto protoreflect.FileDescriptor

const file_v1_tracer_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/tracer.proto\x12\x04conf\"\xef\x02\n" +
	"\x06Tracer\x12\x1a\n" +
	...
	"\x15export_timeout_millis\x18\x05 \x01(\rR\x13exportTimeoutMillisB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"

var (
	file_v1_tracer_proto_rawDescOnce sync.Once
	file_v1_tracer_proto_rawDescData []byte
)

func file_v1_tracer_proto_rawDescGZIP() []byte {
	file_v1_tracer_proto_rawDescOnce.Do(func() {
		file_v1_tracer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_tracer_proto_rawDesc), len(file_v1_tracer_proto_rawDesc)))
	})
	return file_v1_tracer_proto_rawDescData
}

var file_v1_tracer_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_v1_tracer_proto_goTypes = []any{
	(*Tracer)(nil),         // 0: conf.Tracer
	(*BatcherOptions)(nil), // 1: conf.BatcherOptions
}
var file_v1_tracer_proto_depIdxs = []int32{
...
func init() { file_v1_tracer_proto_init() }
func file_v1_tracer_proto_init() {
	if File_v1_tracer_proto != nil {
		return
	}
	file_v1_tracer_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_tracer_proto_rawDesc), len(file_v1_tracer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v1_tracer_proto_goTypes,
		DependencyIndexes: file_v1_tracer_proto_depIdxs,
		MessageInfos:      file_v1_tracer_proto_msgTypes,
	}.Build()
	File_v1_tracer_proto = out.File
	file_v1_tracer_proto_goTypes = nil
	file_v1_tracer_proto_depIdxs = nil
}
