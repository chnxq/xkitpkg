...
type Middleware struct {
	...
	CircuitBreaker       *Middleware_CircuitBreaker `protobuf:"bytes,4,opt,name=circuit_breaker,json=circuitBreaker,proto3" json:"circuit_breaker,omitempty"`
...
func (x *Middleware) GetCircuitBreaker() *Middleware_CircuitBreaker {
	if x != nil {
...
type Middleware_RateLimiter struct {
	...
	Window        *durationpb.Duration   `protobuf:"bytes,2,opt,name=window,proto3,oneof" json:"window,omitempty"`                                  // 统计窗口时长
	Bucket        *int32                 `protobuf:"varint,3,opt,name=bucket,proto3,oneof" json:"bucket,omitempty"`                                 // 窗口桶数量
	CpuThreshold  *int64                 `protobuf:"varint,4,opt,name=cpu_threshold,json=cpuThreshold,proto3,oneof" json:"cpu_threshold,omitempty"` // CPU 限流阈值，千分比，例如 800 表示 80%
	CpuQuota      *float64               `protobuf:"fixed64,5,opt,name=cpu_quota,json=cpuQuota,proto3,oneof" json:"cpu_quota,omitempty"`            // CPU 配额，无法正确探测时可手工指定
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Middleware_RateLimiter) GetWindow() *durationpb.Duration {
	if x != nil {
		return x.Window
	}
	return nil
...
func (x *Middleware_RateLimiter) GetBucket() int32 {
...
func (x *Middleware_RateLimiter) GetCpuThreshold() int64 {
...
func (x *Middleware_RateLimiter) GetCpuQuota() float64 {
...
type Middleware_CircuitBreaker struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Window        *durationpb.Duration   `protobuf:"bytes,1,opt,name=window,proto3,oneof" json:"window,omitempty"`     // 统计窗口时长
	Request       *int64                 `protobuf:"varint,2,opt,name=request,proto3,oneof" json:"request,omitempty"`  // 进入熔断计算的最小请求数
	Bucket        *int32                 `protobuf:"varint,3,opt,name=bucket,proto3,oneof" json:"bucket,omitempty"`    // 窗口桶数量
	Success       *float64               `protobuf:"fixed64,4,opt,name=success,proto3,oneof" json:"success,omitempty"` // 成功率阈值，0-1 之间
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Middleware_CircuitBreaker) GetWindow() *durationpb.Duration {
	if x != nil {
		return x.Window
	}
	return nil
...
func (x *Middleware_CircuitBreaker) GetRequest() int64 {
...
func (x *Middleware_CircuitBreaker) GetBucket() int32 {
	if x != nil && x.Bucket != nil {
		return *x.Bucket
	}
	return 0
...
func (x *Middleware_CircuitBreaker) GetSuccess() float64 {
...
func (x *Middleware_Metrics) Reset() {
	*x = Middleware_Metrics{}
	mi := &file_v1_middleware_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Middleware_Metrics) Descriptor() ([]byte, []int) {
	return file_v1_middleware_proto_rawDescGZIP(), []int{0, 4}
}
...
const file_v1_middleware_proto_rawDesc = "" +
	"\n" +
	"\x13v1/middleware.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\"\x8d\r\n" +
	"\n" +
	"Middleware\x126\n" +
	...
	"\x04auth\x18\x03 \x01(\v2\x15.conf.Middleware.AuthR\x04auth\x12H\n" +
	"\x0fcircuit_breaker\x18\x04 \x01(\v2\x1f.conf.Middleware.CircuitBreakerR\x0ecircuitBreaker\x12%\n" +
	...
	"\x19_refresh_token_key_prefix\x1a\xf8\x01\n" +
	"\vRateLimiter\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x126\n" +
	"\x06window\x18\x02 \x01(\v2\x19.google.protobuf.DurationH\x00R\x06window\x88\x01\x01\x12\x1b\n" +
	"\x06bucket\x18\x03 \x01(\x05H\x01R\x06bucket\x88\x01\x01\x12(\n" +
	"\rcpu_threshold\x18\x04 \x01(\x03H\x02R\fcpuThreshold\x88\x01\x01\x12 \n" +
	"\tcpu_quota\x18\x05 \x01(\x01H\x03R\bcpuQuota\x88\x01\x01B\t\n" +
	"\a_windowB\t\n" +
	"\a_bucketB\x10\n" +
	"\x0e_cpu_thresholdB\f\n" +
	"\n" +
	"_cpu_quota\x1a\xd1\x01\n" +
	"\x0eCircuitBreaker\x126\n" +
	"\x06window\x18\x01 \x01(\v2\x19.google.protobuf.DurationH\x00R\x06window\x88\x01\x01\x12\x1d\n" +
	"\arequest\x18\x02 \x01(\x03H\x01R\arequest\x88\x01\x01\x12\x1b\n" +
	"\x06bucket\x18\x03 \x01(\x05H\x02R\x06bucket\x88\x01\x01\x12\x1d\n" +
	"\asuccess\x18\x04 \x01(\x01H\x03R\asuccess\x88\x01\x01B\t\n" +
	"\a_windowB\n" +
	"\n" +
	"\b_requestB\t\n" +
	"\a_bucketB\n" +
...
var file_v1_middleware_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_v1_middleware_proto_goTypes = []any{
	...
	(*Middleware_CircuitBreaker)(nil), // 4: conf.Middleware.CircuitBreaker
	(*Middleware_Metrics)(nil),        // 5: conf.Middleware.Metrics
	(*durationpb.Duration)(nil),       // 6: google.protobuf.Duration
}
var file_v1_middleware_proto_depIdxs = []int32{
	3, // 0: conf.Middleware.limiter:type_name -> conf.Middleware.RateLimiter
	5, // 1: conf.Middleware.metrics:type_name -> conf.Middleware.Metrics
	2, // 2: conf.Middleware.auth:type_name -> conf.Middleware.Auth
	4, // 3: conf.Middleware.circuit_breaker:type_name -> conf.Middleware.CircuitBreaker
	6, // 4: conf.Middleware.Auth.access_token_expires:type_name -> google.protobuf.Duration
	6, // 5: conf.Middleware.Auth.refresh_token_expires:type_name -> google.protobuf.Duration
	1, // 6: conf.Middleware.Auth.white_list:type_name -> conf.Middleware.WhiteList
	6, // 7: conf.Middleware.RateLimiter.window:type_name -> google.protobuf.Duration
	6, // 8: conf.Middleware.CircuitBreaker.window:type_name -> google.protobuf.Duration
...
func file_v1_middleware_proto_init() {
	...
	file_v1_middleware_proto_msgTypes[3].OneofWrappers = []any{}
	file_v1_middleware_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
