...
func (Script_EngineType) EnumDescriptor() ([]byte, []int) {
	return file_v1_script_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*Script_Lua) Descriptor() ([]byte, []int) {
	return file_v1_script_proto_rawDescGZIP(), []int{0, 1}
}
...
func (*Script_JavaScript) Descriptor() ([]byte, []int) {
	return file_v1_script_proto_rawDescGZIP(), []int{0, 2}
}
...
func (*Script_Python) Descriptor() ([]byte, []int) {
	return file_v1_script_proto_rawDescGZIP(), []int{0, 3}
}
...
const file_v1_script_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/script.proto\x12\x04conf\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x92\v\n" +
	"\x06Script\x12/\n" +
	...
	"\rengine_configB'Z%github.com/chnxq/xkitpkg/conf/v1;confb\x06proto3"
...
var file_v1_script_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
func file_v1_script_proto_init() {
	...
	file_v1_script_proto_msgTypes[0].OneofWrappers = []any{
		(*Script_Lua_)(nil),
