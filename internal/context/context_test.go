...
func TestContext(t *testing.T) {
	type ctxKey1 struct{}
	type ctxKey2 struct{}
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/go-cnf/")
	ctx2 := context.WithValue(context.Background(), ctxKey2{}, "https://go-cnf.dev/")
	...
	if !reflect.DeepEqual(value1, "https://github.com/go-cnf/") {
		t.Errorf("expect %v, got %v", "https://github.com/go-cnf/", value1)
	}
	...
	if !reflect.DeepEqual("https://go-cnf.dev/", value2) {
		t.Errorf("expect %v, got %v", "https://go-cnf.dev/", value2)
	}
...
func TestMerge(t *testing.T) {
	...
	cancel()
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/go-cnf/")
	ctx2 := context.WithValue(ctx, ctxKey2{}, "https://go-cnf.dev/")
	...
	if !reflect.DeepEqual(value2, "https://go-cnf.dev/") {
		t.Errorf("expect %v, got %v", " https://go-cnf.dev/", value2)
	}
