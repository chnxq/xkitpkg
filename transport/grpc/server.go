...
func (s *Server) SetHealthStatus(serviceName string, status int32) {
	ss := grpc_health_v1.HealthCheckResponse_ServingStatus(status)
	s.health.SetServingStatus(serviceName, ss)
}
