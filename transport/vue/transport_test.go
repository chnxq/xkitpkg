...
func TestTransport_Kind(t *testing.T) {
	o := &Transport{}
	if !reflect.DeepEqual(KindVue, o.Kind()) {
		t.Errorf("expect %v, got %v", KindVue, o.Kind())
	}
}
...
func TestSetOperation(t *testing.T) {
	...
	SetOperation(ctx, "xgokit")
	if !reflect.DeepEqual(tr.operation, "xgokit") {
		t.Errorf("expect %v, got %v", "xgokit", tr.operation)
	}
}
