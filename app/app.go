...
func NewApp(appCtx *AppCtx, srv ...transport.Server) *App {
	...
	if appCtx.registrar != nil {
		opts = append(opts, Registrar(appCtx.registrar))
	}
	if len(srv) > 0 {
		opts = append(opts, Server(srv...))
	}
