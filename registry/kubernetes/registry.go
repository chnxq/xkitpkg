...
// xkit needs to cooperate with the following fields to run properly on Kubernetes:
// xkit-service-id: define the ID of the service
// xkit-service-app: define the name of the service
// xkit-service-version: define the version of the service
// xkit-service-metadata: define the metadata of the service
// xkit-service-protocols: define the protocols of the service
//
// Example Deployment:
/*
apiVersion: apps/v1
...
template:
  metadata:
    labels:
      app: nginx
      xkit-service-id: "56991810-c77f-4a95-8190-393efa9c1a61"
      xkit-service-app: "nginx"
      xkit-service-version: "v3.5.0"
    annotations:
      xkit-service-protocols: |
        {"80": "http"}
      xkit-service-metadata: |
...
const (
	...
	LabelsKeyServiceID = "xkit-service-id"
	// LabelsKeyServiceName is used to define the name of the service
	LabelsKeyServiceName = "xkit-service-app"
	// LabelsKeyServiceVersion is used to define the version of the service
	LabelsKeyServiceVersion = "xkit-service-version"
	// AnnotationsKeyMetadata is used to define the metadata of the service
	AnnotationsKeyMetadata = "xkit-service-metadata"
	// AnnotationsKeyProtocolMap is used to define the protocols of the service
	// Through the value of this field; xkit can obtain the application layer protocol corresponding to the port
	// Example value: {"80": "http", "8081": "grpc"}
	AnnotationsKeyProtocolMap = "xkit-service-protocols"
)
